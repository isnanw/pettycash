...
<script type="application/javascript">
    function setAtasan(x){
      if(x == '3' || x == '4'){
        document.getElementById("lineatasan").classList.remove("d-none");
      }else{
        document.getElementById("lineatasan").classList.add("d-none");
        }
      }
    setAtasan(document.getElementById("level").value);
</script>