<!-- MODAL -->
<!-- Add Records Modal -->
<div class="modal fade text-left" id="modal_form_atasan" tabindex="-1" atasan="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" atasan="document">
        <div class="modal-content">
            ...
            <div class="modal-body formatasan">
                <?php
                    $attributes = array('class' => 'form-horizontal', 'id' => 'formatasan');
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="namaatasan" class="form-control namaatasan" id="namaatasan" placeholder="Nama Atasan">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success ml-1 btnSave" id="btnSave" onclick="addatasan()">
...
<!-- Import Modal -->
                                <form id="add-row-form" action="<?php echo site_url('backend/konsumen/import');?>" method="post" enctype="multipart/form-data">
                                        <div class="modal fade text-left" id="import" tabindex="-1" atasan="dialog"
