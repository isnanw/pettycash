	...
	public function get_ajax_list()
	{
		...
		foreach ($list as $d) {
			...
			if ($status == 'PENGAJUAN') {
				...
				$actket = 'Ditolak';
				$actclass = 'danger';
				$button = '<small><span class="bg-light-danger"><b>Ditolak</b>, Pada: <br>'.format_indo(date($d->tgl_pettycash_direktur)).'<br>'.$d->catatan_direktur.'</span></small>';
			}elseif ($status == 'RILIS'){
				$class = 'unlock';
				$ket = 'Ditolak';
				$icon = 'exclamation';
				$actket = 'Dirilis';
				$actclass = 'success';
				$button = '<small><span class="bg-light-success"><b>Dirilis</b>, Pada: <br>'.format_indo(date($d->tgl_pettycash_direktur)).'<br>'.$d->catatan_direktur.'</span><small>';
			}else{
				$class = 'unlock';
				$ket = 'Rilis';
				$icon = 'exclamation';
